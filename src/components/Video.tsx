...
const VideoInfo = () => {
  return (
    <div className="flex flex-row">
      ...
      <div>
        <button className="p-2 pl-3 pr-4 border-2 border-red-400 text-red-400 rounded-md">Follow</button>
      </div>
    </div>
  );
};
...
const VideoContent = () => {
  return <div>
    <video className="w-[80%] max-h-[600px] ml-[50px] rounded-md mt-4" src="https://www.tiktok.com/@footballmoments.x/video/7316745951350099206?is_from_webapp=1&sender_device=pc" loop />
  </div>;
};
